...
def greet():
    speak("Hello Mansi! How may I help you?")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            myPath = "C:\\Users\\Mansi Gupta\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
            os.startfile(myPath)
        elif 'open ms word' in query:
            myPath = "C:\\Program Files\\Microsoft Office\\root\\Office16\\WINWORD.EXE"
            os.startfile(myPath)
        elif 'open power point' in query:
            myPath = "C:\\Program Files\\Microsoft Office\\root\\Office16\\POWERPNT.EXE"
            os.startfile(myPath)
